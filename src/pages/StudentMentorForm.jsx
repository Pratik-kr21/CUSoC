...
const StudentMentorForm = () => {
  ...
  const [canProvide, setCanProvide] = useState([
    'Provide feedback and guidance on work',
  ...
  const handleSubmit = async (e) => {
    ...
    data.append('mentorType', 'Student');
    Object.entries(formData).forEach(([k, v]) => data.append(k, v));
    data.append('skillAreas', JSON.stringify(skillAreas));
    ...
    return (
      <div className="min-h-[calc(100vh-72px)] bg-[#FAFAFA] flex items-center justify-center px-4">
        <div className="text-center max-w-lg">
          ...
          <p className="text-gray-600 font-medium mb-8 leading-relaxed">Thank you for applying as a Student Mentor. We'll review your application and reach out via email.</p>
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-5xl font-black tracking-tight mb-3">
            <span className="text-gray-900">Student Mentor </span>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-8 md:p-10">
          <form onSubmit={handleSubmit} className="space-y-10">
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input required type="email" name="email" placeholder="" onChange={handleChange} className={inputClass} />
                  </div>
                  <div>
            ...
            <div>
              <h2 className={sectionTitleClass}>Academic Information</h2>
              <div className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    <label className={labelClass}>Roll Number</label>
                    <input required name="rollNumber" placeholder="" onChange={handleChange} className={inputClass} />
                  </div>
                  <div>
                    <label className={labelClass}>CU Email</label>
                    <input required name="cuEmail" placeholder="uid@cuchd.in" onChange={handleChange} className={inputClass} />
                  </div>
                </div>
            ...
            {/* Skills & Expertise */}
            <div>
              <h2 className={sectionTitleClass}>Skills & Expertise</h2>
              <div className="space-y-5">
                <div>
                  <label className={labelClass}>Skill Areas</label>
                  <CheckboxGroup
                    options={['Web Development', 'Backend Development', 'Full-Stack Development', 'Machine Learning', 'Cloud Computing', 'Competitive Programming', 'Other', 'Mobile Development', 'Frontend Development', 'Data Science', 'DevOps', 'Open Source', 'UI/UX Design']}
                    selected={skillAreas}
                ...
                <div>
                  ...
                  <CheckboxGroup
                    options={['Coding', 'Web Development', 'Data Structures', 'System Design', 'Code Review', 'Other', 'Problem Solving', 'Mobile Development', 'Algorithms', 'Project Development', 'Technical Writing']}
                ...
                <div>
                  ...
                  <textarea required name="mentorshipGoals" rows={4} placeholder="What do you want to achieve as a peer mentor? How can you help fellow students?" onChange={handleChange} className={inputClass} />
                </div>
                <div>
                  <label className={labelClass}>Mentorship Approach (Optional)</label>
                  <textarea name="mentorshipApproach" rows={4} placeholder="Describe your mentoring style and approach" onChange={handleChange} className={inputClass} />
                </div>
                <div>
                  <label className={labelClass}>Previous Mentoring Experience (Optional)</label>
                  <textarea name="mentoringExperience" rows={4} placeholder="Have you helped peers or juniors? Describe your experience." onChange={handleChange} className={inputClass} />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  "Guide on project selection and planning",
                  "Review code and technical implementations",
                  "Help with competitive programming / DSA concepts",
                  "Share tips on self-learning and open-source contribution",
                ].map(item => (
