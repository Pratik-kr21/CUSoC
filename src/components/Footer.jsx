      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-2">
            <img src="/cusoc.png" alt="CUSoC Logo" className="h-12 w-auto mb-4" />
            <p className="text-gray-500 text-sm leading-relaxed max-w-sm font-medium">
              Chandigarh University Summer of Code — A student-driven open-source program building the next generation of developers through real-world projects and mentorship.
            </p>
          ...
          {/* Apply */}
          <div>
            <h4 className="text-gray-900 font-black text-sm uppercase tracking-widest mb-4">Apply</h4>
          ...
          {/* Program */}
          <div>
            <h4 className="text-gray-900 font-black text-sm uppercase tracking-widest mb-4">Program</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-gray-100 pt-6 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-xs text-gray-400 font-medium">© 2026 Chandigarh University Summer of Code. All rights reserved.</p>
